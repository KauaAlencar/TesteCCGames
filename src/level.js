...
//   'W' = prisioneiro (solta um item ao ser libertado)
// Entidades ficam no tile onde "pisam" (o tile de baixo deve ser sólido).

import { CONFIG } from './config.js';
import { getTile } from './sprites.js';
...
const LEVEL_1 = [
  ...
  '#.................................................###..##.......#########...########........................#################...................................................T......................#',
  '#.................###..................................##...................########........................#################....................##............................###.....................#',
  '#..P........###.W.###.........S.........R..............##...S.W.......................R.....................#################....................##..S.....S.....R.......W.S...###..W.S...R..S.T...F...#',
  '############################################....####################################################################################....###############...##...#########################################',
  '############################################....####################################################################################....###############...##...#########################################',
];

const SOLID = new Set(['#']);
const ENTITY_MARKERS = new Set(['S', 'R', 'T', 'W']);
  ...
  draw(ctx, camX, camY, debug) {
    ...
    for (let r = r0; r <= r1; r++) {
      for (let c = c0; c <= c1; c++) {
        ...
        const x = c * T - camX;
        const y = r * T - camY;
        ctx.drawImage(getTile(!this.isSolid(c, r - 1), c, r), x, y);
        // Sombra nas bordas expostas, para os blocos não virarem uma massa só.
        ctx.fillStyle = COLORS.TILE_EDGE;
        if (!this.isSolid(c + 1, r)) ctx.fillRect(x + T - 1, y, 1, T);
        if (!this.isSolid(c, r + 1)) ctx.fillRect(x, y + T - 1, T, 1);
        if (!this.isSolid(c - 1, r)) {
    ...
    if (this.goal) {
      ...
      // Tremula: a ponta sobe e desce um pixel.
      const wave = Math.floor(performance.now() / 150) % 2;
      ctx.fillRect(gx + 9, gy - 40, 8, 8);
      ctx.fillRect(gx + 17, gy - 40 + wave, 5, 8);
    }
  }
}
